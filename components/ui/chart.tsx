...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  ...
  return <style>{buildThemeCss(id, colorConfig)}</style>;
};
...
// Lê a configuração de um item a partir do payload do Recharts.
const getPayloadConfigFromPayload = (
  ...
  const configLabelKey = readLabelKey();
...
const TooltipRow = ({
  ...
  "color" | "formatter" | "hideIndicator" | "nameKey"
> & {
  config: ChartConfig;
  index: number;
  indicator: "line" | "dot" | "dashed";
