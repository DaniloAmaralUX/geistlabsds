  ...
  return (
    ...
    >
      ...
      >
        {marker.present ? (
          <span
            className="absolute left-0 top-[var(--lifeline-rail)] z-10 h-2.5 w-2.5 -translate-y-1/2 rounded-full bg-blue-500 ring-2 ring-white dark:ring-black"
            aria-hidden="true"
          />
        ) : (
          <span
        ...
        <div className="flex w-full flex-col items-start text-left">
          <p
            className={cn(
              "mb-5 h-4 text-[11px] font-medium leading-4 tabular-nums text-zinc-500 transition-colors duration-300 group-hover:text-black dark:text-zinc-600 dark:group-hover:text-zinc-400",
          ...
          <div
            className={cn(
              "relative w-full pb-10 text-zinc-500 transition-colors duration-300 group-hover:text-black dark:group-hover:text-zinc-300",
                  ...
                  return (
                    <p
                      ...
                      className={cn(
                        ...
                        (marker.width ?? 0) >= 380 && "max-w-[22rem]",
